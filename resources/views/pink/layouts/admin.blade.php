...
<![endif]-->
    ...
    <head>
        ...
        <script type="text/javascript" src="{{ asset(env('THEME')) }}/js/bootstrap-filestyle-1.2.3/src/bootstrap-filestyle.min.js"> </script>

    </head>
    <!-- END HEAD -->
    
    <!-- START BODY -->
    <body class="no_js responsive {{ (Route::currentRouteName() == 'portfolios.show' || Route::currentRouteName() == 'home' || Route::currentRouteName() == 'portfolios.index') ? 'page-template-home-php' : ''}} stretched">
