...
<div id="content-home" class="content group">
    <div class="hentry group">
        <div class="section portfolio">
            ...
            <h3 class="title">{{ trans('ru.last_projects') }}</h3>
	                	...
	                	<div class="work-thumbnail">
		                    ...
		                    <div class="work-overlay">
		                        ...
		                        <p class="work-overlay-categories">
		                            ...
		                            <a href="{{ asset(env('THEME')) }}/category.html">
		                            	{{ $item->filter->title }}
		                            </a>
		                        </p>
		                    </div>
                ...
                <div class="related_project {{ ($k == 4) ? 'related_project_last' : '' }}">
                    <div class="overlay_a related_img">
                        <div class="overlay_wrapper">
                            ...
                            <div class="overlay">
                                <a class="overlay_img" 
                                href="{{ asset(env('THEME')) }}/images/projects/{{ $item->img->path }}" rel="lightbox" title=""></a>
