...
class ArticlesRepository extends Repository {
	...
	public function addArticle($request){
		...
		// 	$data['alias'] = $this->transliterale($data['alias']);
		// }

		if(empty($data['alias'])){
			
			$data['alias'] = $this->transliterale($data['title']);
		}
		//dd($data['alias']);
		...
		//dd($request->image);
		//dd($request->hasfile('convertedFiles'));
		...
		public function updateArticle($request, $alias){
